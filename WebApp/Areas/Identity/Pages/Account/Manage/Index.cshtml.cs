...
namespace WebApp.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        private async Task LoadAsync(ApplicationUser user)
        {
            ...
            {
                CustomerName = user.TenKhachHang,
                Address = user.DiaChi,
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var tenKhachHang = user.TenKhachHang;
            var diaChi = user.DiaChi;
            var phoneNumber = await _userManager.GetPhoneNumberAsync(user);
            if(Input.CustomerName != tenKhachHang)
            {
                user.TenKhachHang = Input.CustomerName;
            ...
            if (Input.Address != diaChi)
            {
                user.DiaChi = Input.Address;
